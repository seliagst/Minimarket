...
<head>
    ...
    <title>Login Karyawan - Sell Mart</title>
...
<div class="main-wrapper">
    ...
    <div class="side-info">
        ...
        <p class="mt-3 fs-5">Portal khusus Karyawan. Kelola stok dan layani pelanggan dengan senyuman.</p>
    </div>

    <div class="login-section">
        <div class="login-card">
            <h3 class="fw-bold mb-1" style="color: var(--heading);">Login Karyawan</h3>
            <p class="text-muted mb-4">Silakan masuk ke akun kerja Anda.</p>
